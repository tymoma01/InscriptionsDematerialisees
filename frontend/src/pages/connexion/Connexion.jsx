...
// tous les autres rôles internes (accueil/coordination, admin) sur le tableau de bord Accueil,
// seul écran qu'ils ont en commun pour l'instant. À revoir quand formateur aura son propre écran.
